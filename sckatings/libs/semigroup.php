         ...
         <div class="col-xs-12 col-sm-9">
          ...
          <div class="row">
            ...
            <div class="col-xs-6 col-lg-4">
              ...
              <p><a class="btn btn-default" href="/?semifinal/<?=$value['name_group']?>" role="button">Подробно &raquo;</a></p>
            </div>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            ...
            <a href="?semigroup" class="list-group-item active">Полуфинал</a>
            <a href="?finalstage" class="list-group-item">Финал</a>
            <? if ($this->admin) {?>
            <label for=""></label>
            <a href="?allsemifinal" class="list-group-item">Общий список</a><?}?>
          </div>
        </div>